...
function SuccessContent() {
  ...
  return (
    <div className="text-center max-w-md mx-auto">
      <div className="w-20 h-20 bg-accent-50 rounded-full flex items-center justify-center mb-8 mx-auto">
      ...
      <div className="bg-zinc-50 rounded-2xl border border-zinc-100 p-6 mb-8">
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-2 bg-black text-white px-8 py-3.5 rounded-full font-bold text-sm hover:bg-zinc-800 transition-colors"
      >
        Nastavi s kupovinom
