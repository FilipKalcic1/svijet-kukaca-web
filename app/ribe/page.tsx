...
export const metadata: Metadata = {
  title: "Svijet Riba - Edukativne majice s pričom",
  description:
    "Premium majice s edukativnom pričom o ribama. Skeniraj QR kod na leđima i otkrij tajni život ribe koju nosiš.",
};

export default async function FishShopPage() {
  ...
  return (
    <div
      className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-accent-300 selection:text-black scroll-smooth"
      data-theme="fish"
    >
      ...
      <footer className="bg-white text-zinc-900 py-20 px-6 mt-20 text-center border-t border-zinc-100">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="font-bold text-xl">Svijet Riba</span>
        </div>
