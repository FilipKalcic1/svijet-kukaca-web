...
export default function ProductPage() {
  ...
  const getSafeImage = (prod: Insect) => {
    if (prod.product_front_image && prod.product_front_image.length > 5) {
      return prod.product_front_image;
    }
    if (prod.image_url && prod.image_url.length > 5) {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin text-zinc-400 w-10 h-10" /></div>;
      ...
      <main className="pt-28 pb-32 max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="flex flex-col space-y-10 pt-4 lg:pt-8">
              ...
              <div>
                 ...
                 <div className="flex items-center gap-4">
                    <div className="flex items-center border border-zinc-200 rounded-full h-12 w-32 justify-between px-2 bg-zinc-50">
                      <button onClick={decreaseQty} className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white text-zinc-600 transition-colors">
                        <Minus size={16} />
                      </button>
                      <span className="font-bold text-lg w-4 text-center">{quantity}</span>
                      <button onClick={increaseQty} className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white text-zinc-600 transition-colors">
                        <Plus size={16} />
                      </button>
                    </div>
            ...
            {/* 4. GUMB ZA KOŠARICU - SADA SPOJEN */}
            <div className="space-y-4">
              <Button 
                onClick={handleAddToCart} // <--- OVDJE JE PROMJENA
              ...
              {/* --- SIGURNOST I PLAĆANJE (Minimalist Grayscale) --- */}
            ...
            {/* Ikone - Sve u jednom redu, sivo i neutralno */}
