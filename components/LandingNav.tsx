      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 md:h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link
            ...
            className="w-11 h-11 md:w-12 md:h-12 rounded-full flex items-center justify-center bg-green-500 text-white shadow-md shadow-green-500/30 hover:bg-green-600 transition-colors"
          >
          ...
          <Link
            ...
            className="w-11 h-11 md:w-12 md:h-12 rounded-full flex items-center justify-center bg-blue-500 text-white shadow-md shadow-blue-500/30 hover:bg-blue-600 transition-colors"
          >
