    ...
    <>
      ...
      <div className="flex flex-col items-center mb-20 space-y-10">
        ...
        <div className="relative w-full max-w-xl group">
          <Search
            className="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-accent-500 transition-colors"
            size={20}
          />
          <Input
            placeholder={theme.searchPlaceholder}
            className="pl-12 pr-12 h-14 rounded-full text-lg border-zinc-200 shadow-sm focus:ring-2 focus:ring-accent-300 focus:border-transparent transition-all"
            value={searchTerm}
            ...
            <Button
              ...
              className={`rounded-full px-6 h-10 transition-all ${
                activeCategory === cat.id
                  ...
                  : "bg-zinc-100 text-zinc-600 hover:bg-accent-100 hover:text-black"
              }`}
            >
              {cat.label}
            </Button>
                ...
                <CardContent className="p-0 h-full flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-600 bg-accent-50 px-2 py-1 rounded-full">
                        {item.category}
                      </p>
                    </div>
